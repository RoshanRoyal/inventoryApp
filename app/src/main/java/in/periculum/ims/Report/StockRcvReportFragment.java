...
public class StockRcvReportFragment extends Fragment {
    String siteid;

    public static StockRcvReportFragment newInstance() {
        StockRcvReportFragment fragment = new StockRcvReportFragment();
        return fragment;
    }

    public StockRcvReportFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.stockrcv_fragment_report, container, false);
